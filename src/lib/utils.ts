...
import { 
  Plus, Tag, Zap, MapPin, Crown, SendHorizontal, Phone, 
  MessageCircle, Instagram, Star, Droplets, Snowflake, Box, Flame, Percent
} from "lucide-react"
...
export const TYPE_COLORS: Record<string, string> = { "indica": "#A855F7", "sativa": "#FBBF24", "hybrid": "#2DD4BF" };
...
export const processProductData = (rawProducts: any[]) => {
